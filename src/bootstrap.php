<!-- based on http://codepen.io/giao/pen/KFnto -->

@@include('head.php', {"pagename": "Bootstrap 3 Kitchen Sink"})
...
@@include('header.php')
  ...
  <p>Please note that this page features all standard Bootstrap elements,
  however only some of the Bootstrap components are enabled in project by default.</p>
  ...
  <div class="container">
  <div class="row">
    <div class="col col-lg-12"><div class="well"><p>col-lg-12</p></div></div>
  </div>
  <div class="row">
      <div class="col col-lg-4"><div class="well"><p>col-lg-4</p></div></div>
     <div class="col col-lg-4"><div class="well"><p>col-lg-4</p></div></div>
     <div class="col col-lg-4"><div class="well"><p>col-lg-4</p></div></div>
  </div>
  <div class="row">
    <div class="col col-lg-6 col-sm-6"><div class="well"><p>col-lg-6</p></div></div>
   <div class="col col-lg-6 col-sm-6"><div class="well"><p>col-lg-6</p></div></div>
  </div>
  <div class="row">
    <div class="col col-lg-9 col-sm-6"><div class="well">col-lg-9 / col-sm-6</div></div>
    <div class="col col-lg-3 col-sm-6"><div class="well">col-lg-3 / col-sm-6</div></div>
  </div>
  </div>
  </section>
  ...
  <section id="buttons">
    ...
    <h2>Button Sizes</h2>
    <ul class="the-buttons clearfix">
        <li><a class="btn btn-small btn-primary" href="#">Small</a></li>
        <li><a class="btn btn-primary" href="#">Medium</a></li>
        <li><a class="btn btn-large btn-primary" href="#">Large</a></li>
    </ul>
    ...
    <div class="row">
      <div class="col col-lg-8">
        ...
        <form class="form-inline well">
          <input type="text" class="col-lg-3" placeholder="Email">
          <input type="password" class="col-lg-3" placeholder="Password">
          <div class="checkbox">
            <label>
        ...
        <form class="form-horizontal well">
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="col-lg-3 input-xlarge" id="input01">
            ...
            <div class="control-group warning">
              ...
              <div class="controls">
                <input type="text" id="inputWarning" class="col-lg-3">
  ...
  <hr>
    ...
    <h2 id="alerts">Bootstrap 3 Alerts</h2>
